...
from app.services.alarm_publisher import publish_alarm_event
...
def handle_sensor_payload(
    ...
    except Exception:  # pragma: no cover - database/network
    ...
    try:
        with session_scope() as session:
            ...
            if entity is None:
                ...
                return
            entity.device_id = _to_str(context.topic)
            if latest_rfid:
                entity.location = latest_rfid
            service.create_bms_data([entity])
    ...
    try:
        with session_scope() as session:
            ...
            if entity is None:
                ...
                return
            entity.device_id = _to_str(context.topic)
            service.create_rfid_data([entity])
    except Exception:  # pragma: no cover
